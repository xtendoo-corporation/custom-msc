...
.. |badge3| image:: https://img.shields.io/badge/github-Xtendoo%2Fxtendoo-lightgray.png?logo=github
    :target: https://github.com/Xtendoo/xtendoo/tree/18.0/msc_fsm
    :alt: Xtendoo/xtendoo

|badge1| |badge2| |badge3|

Módulo unificado de gestión integral de órdenes de trabajo específicamente diseñado para MSC.
...
3. Buscar "MSC - Work Order Management"
...
* **Equipo principal** de órdenes de trabajo
...
2. **Configurar equipos**:
   - Ir a ``Órdenes de Trabajo > Planificación > Equipos``
   - Crear equipos de trabajo
   - Asignar técnicos a equipos
   - Definir territorios de trabajo

3. **Personalizar etapas**:
...
3. Completar información básica:
   ...
   - **Equipo**: Asignar equipo responsable
...
4. En las pestañas adicionales:
   - **Técnicos y Equipos**: Asignar múltiples técnicos y equipos a revisar
   - **Materiales**: Registrar materiales a utilizar
   - **Fechas y Tiempo**: Registrar hojas de tiempo
   - **Ventas y Facturación**: Gestionar aspectos comerciales
