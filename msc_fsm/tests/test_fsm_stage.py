...
class TestFSMStage(TransactionCase):
    ...
    def test_stage_creation(self):
        ...
        stage = self.env["msc.fsm.stage"].create(
            {
                "name": "New Stage",
                "code": "new_stage",
                "sequence": 10,
    ...
    def test_default_stage(self):
        ...
        default_stage = self.env["msc.fsm.stage"].create(
            {
                "name": "Default Stage",
                "code": "default",
                "sequence": 1,
        ...
        regular_stage = self.env["msc.fsm.stage"].create(
            {
                "name": "Regular Stage",
                "code": "regular",
                "sequence": 2,
    ...
    def test_closed_stage(self):
        ...
        closed_stage = self.env["msc.fsm.stage"].create(
            {
                "name": "Completed Test",
                "code": "done_test",
                "sequence": 100,
    ...
    def test_stage_sequence(self):
        ...
        stage1 = self.env["msc.fsm.stage"].create(
            {
                "name": "Stage 1",
                "code": "stage1",
                "sequence": 10,
        ...
        stage2 = self.env["msc.fsm.stage"].create(
            {
                "name": "Stage 2",
                "code": "stage2",
                "sequence": 5,
        ...
        stage3 = self.env["msc.fsm.stage"].create(
            {
                "name": "Stage 3",
                "code": "stage3",
                "sequence": 15,
        ...
        stages = self.env["msc.fsm.stage"].search(
            [("id", "in", [stage1.id, stage2.id, stage3.id])], order="sequence"
        )
    ...
    def test_stage_company_filter(self):
        ...
        stage_company1 = self.env["msc.fsm.stage"].create(
            {
        ...
        stage_global = self.env["msc.fsm.stage"].create(
            {
                "name": "Global Stage",
                "code": "global",
                "sequence": 2,
        ...
        company_stages = self.env["msc.fsm.stage"].search(
...
class TestDaruclimeFSMStage(TransactionCase):
    ...
    def test_stage_default_validation(self):
        ...
        stage1.invalidate_recordset(["is_default"])
